...
import os
file1=open("judgement.xlsx","r")
#print(file1.read())
csv_file=csv.reader(file1)
import pandas as pd

# read by default 1st sheet of an excel file
dataframe1 = pd.read_excel('judgement.xlsx')
...
for i in dataframe1['Unnamed: 1']:
    ...
    if count==1:
        ...
        print(i)
    temp_summary2="You are asked to be a judge of a legal case and provide a judgment of the following legal judgment:- {"+str(i)+"}.Think Step by Step."
            #try:
